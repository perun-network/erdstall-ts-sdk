...
export interface ERC721TestTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface ERC721TestToken extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721TestToken;
  waitForDeployment(): Promise<this>;

  interface: ERC721TestTokenInterface;
  ...
  mint: TypedContractMethod<
    [recipient: AddressLike, ids: BigNumberish[]],
    [void],
    "nonpayable"
  >;
