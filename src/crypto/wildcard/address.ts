...
export class WildcardAddress extends Address<"wildcard"> {
	...
	override addressType(): AddressType { return AddressType.Wildcard; }
	override equals(other: WildcardAddress): boolean
		{ return this.#id == other.#id; }
	override toString(): string { return this.#id.toString(); }
	override toJSON(): string { return this.#id.toString(16); }
	...
	override clone(): this { return new WildcardAddress(this.#id) as this; }

	override encode_impl(w: CodecWriter): void { w.u64(this.#id); }
	...
	static toJSON(me: WildcardAddress): any { return me.toJSON(); }
