...
export class SignedPublicTxReceipt extends ErdstallObject {
	...
	override objectType() { return SignedPublicTxReceipt; }
	override objectTypeName() { return publicTxReceiptTypeName; }
...
export class SignedDirectTxReceipt extends ErdstallObject {
		constructor(
	public sig: SignedMessage<DirectTxReceipt>
		) { super(); }

	override objectType() { return SignedDirectTxReceipt; }
	override objectTypeName() { return directTxReceiptTypeName; }
	...
	override encode(w: CodecWriter): void { this.sig.encode(w); }
